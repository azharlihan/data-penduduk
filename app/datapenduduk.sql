...
DROP TABLE IF EXISTS `dp_data_penduduk`;

CREATE TABLE `dp_data_penduduk` (
...
insert  into `dp_hubungan_keluarga`(`id_stat_hbkel`,`stat_hbkel`) values (1,'Kepala Keluarga'),(2,'Suami'),(3,'Istri'),(4,'Anak'),(5,'Menantu'),(6,'Cucu'),(7,'Orang Tua'),(8,'Mertua'),(9,'Famili Lain'),(10,'Pembantu'),(11,'Lainnya');
